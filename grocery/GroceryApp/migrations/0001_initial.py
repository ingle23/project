# Generated by Django 5.0.1 on 2024-03-07 08:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('VEGETABLES', 'vegetables'), ('FRUITS', 'fruits'), ('PHARMACY', 'pharmacy'), ('PETFOOD', 'petfood'), ('JUICES', 'juices'), ('SPROUTS', 'sprouts'), ('MILKS', 'milks'), ('BREADS', 'breads')], max_length=20)),
                ...
                ('pet_image', models.ImageField(upload_to='grocery_images')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GroceryApp.grocery')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('grocery_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GroceryApp.grocery')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
